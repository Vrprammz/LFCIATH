...
.lfciath-header-nav-link:link,
.lfciath-header-nav-link:visited {
    font-family: var(--lfc-font-en, "Montserrat", sans-serif);
    font-size: 13px; font-weight: 600; letter-spacing: 0.5px;
    color: #fff !important; text-decoration: none; padding: 8px 14px;
    transition: all 0.3s ease; white-space: nowrap;
}
.lfciath-header-nav-link:hover { color: rgba(255,255,255,0.7) !important; text-decoration: none; }
.lfciath-site-header.scrolled .lfciath-header-nav-link,
.lfciath-site-header.scrolled .lfciath-header-nav-link:link,
.lfciath-site-header.scrolled .lfciath-header-nav-link:visited { color: #1A1A1A !important; }
